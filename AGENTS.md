...
The most complete variant so far is FirstHalfOfGame.cdl, prefer that over custom disassembly, but feel free to use files in .agents if it doesn't suffice.

Don't modify and source code unless I mention the word IMPLEMENT in all caps.