...
// coverage, re-log with more of the game exercised and regenerate this list.
static const uint32_t kFastRomBankBumps[] = {
    ...
    0x0D023, 0x0D02B, 0x0D04F, 0x0D0B9, 0x0D0FD, 0x0D101, 0x0D124, 0x0D15F,
    ...
    0x15833, 0x1586A, 0x1590A, 0x159A1, 0x159A5, 0x15DDF, 0x15DEE, 0x15DF8,
...
int main(int argc, const char** argv) {
    ...
    auto cli = lyra::opt(input_file, "input")
               ...
               | lyra::opt(fast_rom)
                ["-f"]["--fast-rom"]("Experimental: convert to LoROM+FastROM (flag header, enable $420D, run boot + 365 logged long-jumps from bank $80; CLI-only)");
